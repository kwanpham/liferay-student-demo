...
import kwan.org.database.model.StudentModel;
import kwan.org.database.model.StudentSoap;
...
public class StudentModelImpl extends BaseModelImpl<Student>
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(kwan.org.database.service.util.ServiceProps.get(
				"lock.expiration.time.kwan.org.database.model.Student"));
	...
	public Object clone() {
		...
		studentImpl.setGender(isGender());
	...
	public CacheModel<Student> toCacheModel() {
		...
		studentCacheModel.gender = isGender();
	...
	public String toXmlString() {
		...
		sb.append("kwan.org.database.model.Student");
