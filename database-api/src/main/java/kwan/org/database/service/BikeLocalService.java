...
/**
 * Provides the local service interface for Bike. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BikeLocalServiceUtil
...
public interface BikeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BikeLocalServiceUtil} to access the bike local service. Add custom service methods to {@link kwan.org.database.service.impl.BikeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Bike addBike(long userId, String bikeName, String brand,
		long studentId, ServiceContext serviceContext)
	...
	*/
	...
	public Bike deleteBike(long bikeId, ServiceContext serviceContext)
		throws PortalException;
	...
	*/
	...
	public Bike updateBike(long userId, long bikeId, String bikeName,
		String brand, long studentId, ServiceContext serviceContext)
		throws PortalException;
}