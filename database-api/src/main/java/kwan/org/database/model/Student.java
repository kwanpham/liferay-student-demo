 ...
 * @see StudentModel
 * @see kwan.org.database.model.impl.StudentImpl
 * @see kwan.org.database.model.impl.StudentModelImpl
 * @generated
 */
@ImplementationClassName("kwan.org.database.model.impl.StudentImpl")
@ProviderType
public interface Student extends StudentModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link kwan.org.database.model.impl.StudentImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
